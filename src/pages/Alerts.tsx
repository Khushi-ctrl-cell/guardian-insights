...
const alertsData: Alert[] = [
  {
    ...
    amount: 250000,
    riskScore: 94,
    reason: "FPD probability 87% — loan stacking detected across 3 platforms",
    location: "Mumbai, IN",
  ...
  },
  {
    ...
    type: "Loan Stacking",
    userId: "APP-4521",
    timestamp: "2026-02-15 14:28:45",
    status: "open",
    amount: 180000,
    riskScore: 78,
    reason: "Same PAN used for 2 applications within 48 hours across platforms",
    location: "Delhi, IN",
  ...
  },
  {
    ...
    userId: "APP-9182",
    timestamp: "2026-02-15 14:15:32",
    status: "under_review",
    amount: 320000,
    riskScore: 72,
    reason: "Identity graph shows synthetic pattern — name/address/phone cluster mismatch",
  ...
  },
  {
    ...
    type: "Device Anomaly",
    userId: "APP-3847",
    timestamp: "2026-02-15 13:58:21",
    status: "open",
    amount: 95000,
    riskScore: 54,
    reason: "New device fingerprint, GPS spoofing indicators detected",
    location: "Chennai, IN",
  ...
  },
  {
    ...
    type: "FPD Prediction",
    userId: "APP-6712",
    timestamp: "2026-02-15 13:45:09",
    status: "open",
    amount: 450000,
    riskScore: 91,
    reason: "FPD probability 91% — income inconsistency + velocity spike",
  ...
  },
  {
    ...
    userId: "APP-2938",
    timestamp: "2026-02-15 13:32:44",
    status: "resolved",
    amount: 150000,
    riskScore: 41,
    reason: "KYC address 400km from device geolocation — verified as travel",
    location: "Pune, IN",
    device: "Pixel 8",
  },
];
